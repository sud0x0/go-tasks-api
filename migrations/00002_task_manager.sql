...
-- Add foreign key constraint for answer_select after task_select_options exists
ALTER TABLE task_answers
    ADD CONSTRAINT fk_task_answers_select_option
    FOREIGN KEY (answer_select) REFERENCES task_select_options(id) ON DELETE SET NULL;
...
ALTER TABLE IF EXISTS task_answers DROP CONSTRAINT IF EXISTS chk_single_answer;
